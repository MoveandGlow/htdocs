(function (factory) {
    ...
    replaceInput = [
        "<button type='button' class='tnp-sp-replacer'>",
            "<span class='tnp-sp-preview'><span class='tnp-sp-preview-inner'></span></span>",
            "<span class='tnp-sp-dd'>&#9660;</span>",
        "</button>"
    ].join(''),
    markup = (function () {
        ...
        if (IE) {
            for (var i = 1; i <= 6; i++) {
                gradientFix += "<div class='tnp-sp-" + i + "'></div>";
            }
        }

        return [
            "<div class='tnp-sp-container tnp-sp-hidden'>",
                "<div class='tnp-sp-palette-container'>",
                    "<div class='tnp-sp-palette tnp-sp-thumb tnp-sp-cf'></div>",
                    "<div class='tnp-sp-palette-button-container tnp-sp-cf'>",
                        "<button type='button' class='tnp-sp-palette-toggle'></button>",
                    "</div>",
                "</div>",
                "<div class='tnp-sp-picker-container'>",
                    "<div class='tnp-sp-top tnp-sp-cf'>",
                        "<div class='tnp-sp-fill'></div>",
                        "<div class='tnp-sp-top-inner'>",
                            "<div class='tnp-sp-color'>",
                                "<div class='tnp-sp-sat'>",
                                    "<div class='tnp-sp-val'>",
                                        "<div class='tnp-sp-dragger' tabindex='0'></div>",
                                    "</div>",
                                "</div>",
                            "</div>",
                            "<div class='tnp-sp-clear tnp-sp-clear-display'>",
                            "</div>",
                            "<div class='tnp-sp-hue'>",
                                "<div class='tnp-sp-slider' tabindex='0'></div>",
                                gradientFix,
                            "</div>",
                        "</div>",
                        "<div class='tnp-sp-alpha'><div class='tnp-sp-alpha-inner'><div class='tnp-sp-alpha-handle' tabindex='0'></div></div></div>",
                    "</div>",
                    "<div class='tnp-sp-input-container tnp-sp-cf'>",
                        "<input class='tnp-sp-input' type='text' spellcheck='false'  />",
                    "</div>",
                    "<div class='tnp-sp-initial tnp-sp-thumb tnp-sp-cf'></div>",
                    "<div class='tnp-sp-button-container tnp-sp-cf'>",
                        "<button type='button' class='tnp-sp-cancel'></button>",
                        "<button type='button' class='tnp-sp-choose'></button>",
                    "</div>",
                "</div>",
            "</div>"
        ].join("");
    ...
    function paletteTemplate (p, color, className, opts) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            if(current) {
                ...
                var c = tiny.toHsl().l < 0.5 ? "tnp-sp-thumb-el tnp-sp-thumb-dark" : "tnp-sp-thumb-el tnp-sp-thumb-light";
                c += (tinycolor.equals(color, current)) ? " tnp-sp-thumb-active" : "";
                var formattedString = tiny.toString(opts.preferredFormat || "rgb");
                var swatchStyle = rgbaSupport ? ("background-color:" + tiny.toRgbString()) : "filter:" + tiny.toFilter();
                html.push('<span title="' + formattedString + '" data-color="' + tiny.toRgbString() + '" class="' + c + '" role="button" tabindex="0"><span class="tnp-sp-thumb-inner" style="' + swatchStyle + ';"></span></span>');
            } else {
                html.push('<span class="tnp-sp-thumb-el tnp-sp-clear-display" role="button" tabindex="0"><span class="tnp-sp-clear-palette-only" style="background-color: transparent;"></span></span>');
            }
        }
        return "<div class='tnp-sp-cf " + className + "'>" + html.join('') + "</div>";
    }
    ...
    function spectrum(element, o) {
        ...
        var doc = element.ownerDocument,
            ...
            pickerContainer = container.find(".tnp-sp-picker-container"),
            dragger = container.find(".tnp-sp-color"),
            dragHelper = container.find(".tnp-sp-dragger"),
            slider = container.find(".tnp-sp-hue"),
            slideHelper = container.find(".tnp-sp-slider"),
            alphaSliderInner = container.find(".tnp-sp-alpha-inner"),
            alphaSlider = container.find(".tnp-sp-alpha"),
            alphaSlideHelper = container.find(".tnp-sp-alpha-handle"),
            textInput = container.find(".tnp-sp-input"),
            paletteContainer = container.find(".tnp-sp-palette"),
            initialColorContainer = container.find(".tnp-sp-initial"),
            cancelButton = container.find(".tnp-sp-cancel"),
            clearButton = container.find(".tnp-sp-clear"),
            chooseButton = container.find(".tnp-sp-choose"),
            toggleButton = container.find(".tnp-sp-palette-toggle"),
            isInput = boundElement.is("input"),
            isInputTypeColor = isInput && boundElement.attr("type") === "color" && inputTypeColorSupport(),
            shouldReplace = isInput && type == 'color',
            replacer = (shouldReplace) ? $(replaceInput).addClass(theme).addClass(opts.className).addClass(opts.replacerClassName) : $([]),
            offsetElement = (shouldReplace) ? replacer : boundElement,
            previewElement = replacer.find(".tnp-sp-preview-inner"),
        ...
        function applyOptions() {
            ...
            container.toggleClass("tnp-sp-flat", flat);
            container.toggleClass("tnp-sp-input-disabled", !opts.showInput);
            container.toggleClass("tnp-sp-alpha-enabled", opts.showAlpha);
            container.toggleClass("tnp-sp-clear-enabled", allowEmpty);
            container.toggleClass("tnp-sp-buttons-disabled", !opts.showButtons);
            container.toggleClass("tnp-sp-palette-buttons-disabled", !opts.togglePaletteOnly);
            container.toggleClass("tnp-sp-palette-disabled", !opts.showPalette);
            container.toggleClass("tnp-sp-palette-only", opts.showPaletteOnly);
            container.toggleClass("tnp-sp-initial-disabled", !opts.showInitial);
        ...
        function initialize() {
            ...
            originalInputContainer = $('<span class="tnp-sp-original-input-container"></span>');
            ...
            if (shouldReplace) {
                ...
                originalInputContainer.addClass('tnp-sp-colorize-container');
                boundElement.addClass('spectrum tnp-sp-colorize').wrap(originalInputContainer);
            } else if (type == 'component') {
                boundElement.addClass('spectrum').wrap(originalInputContainer);
                var addOn = $(["<div class='tnp-sp-colorize-container tnp-sp-add-on'>",
                    "<div class='tnp-sp-colorize'></div> ",
                "</div>"].join(''));
            ...
            colorizeElement = boundElement.parent().find('.tnp-sp-colorize');
            ...
            function paletteElementClick(e) {
                if (e.data && e.data.ignore) {
                    set($(e.target).closest(".tnp-sp-thumb-el").data("color"));
                    move();
                }
                else {
                    set($(e.target).closest(".tnp-sp-thumb-el").data("color"));
            ...
            paletteContainer.on(paletteEvent, ".tnp-sp-thumb-el", paletteElementClick);
            initialColorContainer.on(paletteEvent, ".tnp-sp-thumb-el:nth-child(1)", { ignore: true }, paletteElementClick);
        }
        ...
        function drawPalette() {
            ...
            var html = $.map(paletteArray, function (palette, i) {
                return paletteTemplate(palette, currentColor, "tnp-sp-palette-row tnp-sp-palette-row-" + i, opts);
            });

            updateSelectionPaletteFromStorage();

            if (selectionPalette) {
                html.push(paletteTemplate(getUniqueSelectionPalette(), currentColor, "tnp-sp-palette-row tnp-sp-palette-row-selection", opts));
            }
        ...
        function drawInitial() {
            if (opts.showInitial) {
                ...
                var current = get();
                initialColorContainer.html(paletteTemplate([initial, current], current, "tnp-sp-palette-row-initial", opts));
            }
        }
        ...
        function setFromTextInput(value) {
            ...
            if ((value === null || value === "") && allowEmpty) {
                ...
                if (tiny.isValid()) {
                    ...
                    textInput.addClass("tnp-sp-validation-error");
                }
            }
        }
        ...
        function show() {
            ...
            replacer.addClass("tnp-sp-active");
            container.removeClass("tnp-sp-hidden");
        ...
        function hide() {
            ...
            replacer.removeClass("tnp-sp-active");
            container.addClass("tnp-sp-hidden");
        ...
        function isValid() {
            return !textInput.hasClass("tnp-sp-validation-error");
        }
        ...
        function updateUI() {
            ...
            textInput.removeClass("tnp-sp-validation-error");
            ...
            previewElement.removeClass("tnp-sp-clear-display");
            previewElement.css('background-color', 'transparent');

            if (!realColor && allowEmpty) {
                // Update the replaced elements background with icon indicating no color selection
                previewElement.addClass("tnp-sp-clear-display");
            }
            else {
        ...
        function destroy() {
            boundElement.show().removeClass('spectrum with-add-on tnp-sp-colorize');
            ...
            var originalInputContainer = boundElement.closest('.tnp-sp-original-input-container');
        ...
        function enable() {
            ...
            offsetElement.removeClass("tnp-sp-disabled");
        }
        ...
        function disable() {
            ...
            offsetElement.addClass("tnp-sp-disabled");
        }
    ...
    function draggable(element, onmove, onstart, onstop) {
        ...
        function start(e) {
            ...
            if (!rightclick && !dragging) {
                if (onstart.apply(element, arguments) !== false) {
                    ...
                    $(doc.body).addClass("tnp-sp-dragging");
        ...
        function stop() {
            if (dragging) {
                ...
                $(doc.body).removeClass("tnp-sp-dragging");
